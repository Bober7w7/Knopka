...
* **Сборка:** Все элементы скрепляются с помощью цианакрилатного клея-геля.
...
* **Датчик события:**  Тактовая кнопка на нижней грани ладони для регистрации контакта с объектом.
